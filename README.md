...
`0.7.5`
- We have retired the RXN and Deep Search toolkits and replaced them with new and more user-friendly plugins. More information on the [plugin](#README/plugins.md) page.
